...
- **PQ sounds**: the stage/PQ clear voice is `Sound.wz/Field.img/Party1/Clear` and a failed run is `Party1/Failed` — `Game.img/QuestClear` is the quest-completion jingle and wrong for party quests.
